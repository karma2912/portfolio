      ...
      <div className="text-white min-h-screen w-full ">
        ...
        <div className="h-full w-full md:pt-[30rem] pt-24  flex flex-col md:gap-28 gap-14 justify-center items-center">
          ...
          <div className="w-11/12 text-md text-center flex md:flex-row flex-col justify-around items-center">
           <div className="h-[29rem] md:h-[40rem] md:w-1/3 w-full flex flex-col justify-evenly items-center border-2 border-slate-400 p-2 rounded-xl" ><div className="text-5xl font-bold meet ">Meet Yash Rajak,</div>
