...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen w-full flex md:flex-row flex-col">
      <div className="md:h-screen h-[80rem] md:w-1/2 w-full text-white flex flex-col md:justify-evenly justify-around items-center md:pl-60 pl-20 md:pr-20 pr-10 md:pt-24 pt-24">
        <div className="min-h-1/2">
          ...
          <div className="pt-14 flex items-center gap-9 text-lg font-medium">
            ...
            <div className="flex gap-3">
              <a className="text-base hover:scale-125">
                My Works <i className="fa-solid fa-greater-than"></i>
              </a>
            </div>
          </div>
        </div>
        <div className="md:h-fit flex md:flex-row flex-col w-full justify-between h-[20rem]">
          <div>
      ...
      <div className="flex md:flex-col flex-row justify-around md:h-52 h-fit text-lg md:w-fit w-full">
        <i className="fa-brands fa-meta border border-black rounded-full bg-black p-3 text-center meta hover:scale-125"></i>
        <i className="fa-brands fa-x-twitter border border-black rounded-full bg-black p-3 text-center twitter hover:scale-125"></i>
        <i className="fa-brands fa-linkedin-in border border-black rounded-full bg-black p-3 text-center li hover:scale-125"></i>
        </div>
      </div>
      </div>
    </>
