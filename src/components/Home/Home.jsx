...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen w-full flex md:flex-row flex-col ">
      <div className="md:h-screen h-[80rem] md:w-1/2 w-full text-white flex flex-col justify-evenly items-center 2xl:pl-60 xl:pl-40 pl-14 md:pr-20 pr-10 ">
      ...
      <div className="md:h-screen min-h-[50rem] md:w-1/2 w-full text-white flex md:flex-row flex-col justify-evenly items-center pr-30 pl-30 md:pt-24 pt-10">
